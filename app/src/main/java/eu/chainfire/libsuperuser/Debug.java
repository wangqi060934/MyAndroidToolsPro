...
public class Debug {
     ...
     *
     * @param type          Type of message to debug
     ...
     *
     * <p>These messages are infrequent and mostly occur at startup/shutdown or on err</p>
     *
     * @param message The message to debug
     */
    ...
    /**
     * <p>Register a custom debug handler</p>
     *
     * <p>Replaces the debug method (write to logcat) with your own
     * handler. Whether your handler gets called is still dependent
     * on debug mode and message types being enabled for logging.</p>
     *
     * @param onLogListener Custom debug listener or NULL to revert to default
     */
    ...
    /**
     * <p>Get the currently registered custom debug handler</p>
     *
     * @return Current custom debug handler or NULL if none is present
     */
