...
public class Shell {
     ...
     * @return Output of the commands, or null in case of an err
     */
    @Deprecated
     ...
     * </p>
     * <p>
     * When in debug mode, the code will also excessively debug the commands
    ...
    public static List<String> run(String shell, String[] commands, String[] environment,
        ...
        try {
            ...
            //wangqi:exitcode bug
            boolean isSu = SU.isSU(shell);
            final int exitValue = process.exitValue();
            if (commands.length > 0) {
                Utils.debug("Root command1:" + commands[0]);
            }
            Utils.debug("Root command1 exitcode:" + exitValue);
            if (isSu && (exitValue != 0)) {
                res = null;
            }
...
//            }
    ...
    public static List<String> run(String shell, String[] commands, String[] environment,
                                   boolean wantSTDOUT,boolean wantSTDERR) {
        String shellUpper = shell.toUpperCase(Locale.ENGLISH);
        ...
        try {
            ...
            final int exitValue = process.exitValue();
            if (commands.length > 0) {
                Utils.debug("Root command:" + commands[0]);
            }
            Utils.debug("Root command exitcode:" + exitValue);
            if (isSu && (exitValue == 255)) {   //禁用的component不存在的时候返回1，拒绝的时候也返回1
                res = null;
            }
...
//            }
     ...
     *                     root
     * @return true on success, false on err
     */
    ...
    public static class SH {
         ...
         * @return Output of the command, or null in case of an err
         */
    ...
    public static class SU {
        ...
        //wangqi，process.exitValue()的判断改动了
        public static List<String> runGetOnlyErr(String command) {
            return Shell.run("su", new String[]{
                    command
            }, null, false, true);
        }
        ...
        //wangqi，同时获取err
        public static List<String> runGetAll(String command) {
            return Shell.run("su", new String[]{
                    command
            }, null, true, true);
        }
    ...
    public static class Builder {
        ...
        /**
         * Set if err output should be appended to command block result output
         *
         * @param wantSTDERR Want err output ?
         * @return This Builder object for method chaining
         */
