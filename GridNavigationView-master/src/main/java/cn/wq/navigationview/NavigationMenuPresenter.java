...
//                R.dimen.design_navigation_separator_vertical_padding);
    ...
    public MenuView getMenuView(ViewGroup root) {
        if (mMenuView == null) {
            mMenuView = (NavigationMenuView) mLayoutInflater.inflate(
                    R.layout.design_grid_navigation_menu, root, false);
            if (mAdapter == null) {
                mAdapter = new NavigationMenuAdapter();
            }

            mHeaderLayout = (LinearLayout) mLayoutInflater
                    .inflate(R.layout.design_grid_navigation_item_header,
                            mMenuView, false);
    ...
    private static class NormalViewHolder extends ViewHolder {
        ...
        public NormalViewHolder(LayoutInflater inflater, ViewGroup parent,
            ...
            super(inflater.inflate(R.layout.design_grid_navigation_item, parent, false));
    ...
    private static class SubheaderViewHolder extends ViewHolder {
        ...
        public SubheaderViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.design_grid_navigation_item_subheader, parent, false));
        }
    ...
    private static class SeparatorViewHolder extends ViewHolder {
        ...
        public SeparatorViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.design_grid_navigation_item_separator, parent, false));
        }
    ...
    private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public Bundle createInstanceState() {
            ...
            actionViewStates = new SparseArray<>();
